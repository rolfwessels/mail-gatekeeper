...
public class RuleEngineTests
{
  ...
  [TestCase("sender@company.org", "Email verification required", "", "verification")]
  [TestCase("someone@service.com", "Reset password request", "", "reset password")]
  [TestCase("person@business.com", "Password reset link", "", "password reset")]
